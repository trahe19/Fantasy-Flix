    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center space-x-4">
              <img src="/images/logo.png" alt="Fantasy Flix" className="w-24 h-24 drop-shadow-2xl object-contain" style={{aspectRatio: '1/1'}} />
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 lg:px-8 max-w-6xl mx-auto">
          <div className="mb-8 animate-fade-in-up">
            <img src="/images/logo.png" alt="Fantasy Flix Logo" className="w-48 h-48 mx-auto mb-8 drop-shadow-2xl animate-pulse-glow object-contain" style={{aspectRatio: '1/1'}} />
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-10 rounded-3xl border border-amber-500/20 shadow-2xl">
                <img src="/images/logo.png" alt="Fantasy Flix" className="w-40 h-40 mx-auto mb-8 animate-pulse-glow object-contain" style={{aspectRatio: '1/1'}} />
      ...
      <section id="join" className="py-24 bg-gradient-to-r from-red-900 via-black to-amber-900">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          <div className="mb-12">
            <img src="/images/logo.png" alt="Fantasy Flix" className="w-48 h-48 mx-auto mb-8 animate-pulse-glow object-contain" style={{aspectRatio: '1/1'}} />
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-4 mb-6">
                <img src="/images/logo.png" alt="Fantasy Flix" className="w-24 h-24 object-contain" style={{aspectRatio: '1/1'}} />
